...
const es: Dictionary = {
  ...
  income_fx_field: "Tasa USD → COP",
  income_fx_hint: "Cuántos pesos vale un dólar. Escribe uno de los dos montos y el otro se calcula.",
  ...
  debt_action_settle: "Finalizar deuda",
  debt_settle_confirm: "Se creará un movimiento de {amount} en el mes actual y la deuda quedará saldada. ¿Sigo?",
  debt_settle_done: "Deuda finalizada: el pago final quedó en el mes actual.",
...
const en: Dictionary = {
  ...
  monthly_entries_usd: "USD",
  monthly_income_fx: "FX",
  income_fx_field: "USD → COP rate",
  income_fx_hint: "How many pesos a dollar is worth. Type one of the two amounts and the other follows.",
  ...
  debt_action_settle: "Settle debt",
  debt_settle_confirm: "A {amount} movement will be added to the current month and the debt will be settled. Go ahead?",
  debt_settle_done: "Debt settled: the final payment landed in the current month.",
  debt_link_eyebrow: "Cash flow",
